<template>
  <div>
    <div class="card" style="margin-bottom: 5px;">
      ...
      <el-select style="width: 300px;margin-right: 10px" v-model="data.categoryId" placeholder="请选择商品的分类">
...
/* wangEditor5 初始化开始 */
const baseUrl = import.meta.env.VITE_BASE_URL // 在.env.development中，VITE_BASE_URL='http://localhost:9090'
